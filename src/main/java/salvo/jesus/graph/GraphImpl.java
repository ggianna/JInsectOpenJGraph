...
public class GraphImpl implements Graph {
     ...
     */
    private Map<Vertex,VertexData> vertexDataMap;
    ...
    private final void invokeAddVertexListeners(
    ...
    private final void invokeRemoveVertexListeners(
    ...
    private final void invokeAddEdgeListeners(
    ...
    private final void invokeRemoveEdgeListeners(
